# Python program of the above approach Stores the overlapping state
...
# Driver Code
A = int(input("Enter No. of Bananas at starting: "))
B = int(input("Enter the distance you want to cover: "))
C = int(input(" Enter max load capacity of your camel: "))
print("The Max banana camel can take : ",maxBananaCnt(A, B, C))
